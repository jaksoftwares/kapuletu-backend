...
## 🏗️ 1. Infrastructure: Docker & PostgreSQL
...
## 🛠️ 2. Migration Management: Alembic
...
> [!NOTE]
> This prevents circular import errors (e.g., between `User` and `Group`) and ensures that Alembic can "see" all tables through a single metadata object.
