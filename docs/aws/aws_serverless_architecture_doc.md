...
| **Environment** | Local Python Process | Isolated MicroVMs |
| **Database** | Docker (PostgreSQL 15) | Amazon RDS (PostgreSQL) |

---

## 🔐 6. Security & Scaling
- **Concurrency**: AWS Lambda scales automatically.
- **IAM Roles**: Each Lambda function has a specific security profile.
- **Cold Starts**: Initial request latency is expected after idle periods.
